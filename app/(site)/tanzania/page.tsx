...
const MONEY = [
  ...
  { href: "/tools/tanzania-employer-cost-calculator", title: "Employer Cost Calculator", desc: "NSSF + SDL + WCF — true cost of hiring staff" },
  { href: "/tools/tanzania-sdl-calculator", title: "Tanzania SDL Calculator", desc: "Skills Development Levy (3.5%, 10+ staff)" },
  { href: "/tools/tanzania-wcf-calculator", title: "Tanzania WCF Calculator", desc: "Workers Compensation Fund (0.5% employer)" },
